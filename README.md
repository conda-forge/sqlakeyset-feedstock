...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sqlakeyset-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13638&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sqlakeyset-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sqlakeyset` can be installed with:

```
conda install sqlakeyset
```

It is possible to list all of the versions of `sqlakeyset` available on your platform with:
